    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 flex flex-col gap-5">
        ...
        <div className="bg-slate-900/50 border border-slate-700 rounded-lg p-4">
          ...
          <div className="text-2xl font-mono font-bold text-zinc-100 tracking-widest">XXXXX</div>
          <div className="text-xs text-slate-500 mt-1">Share this code with your friends</div>
        </div>

        <button className="w-full bg-zinc-800 hover:bg-zinc-700 text-white py-3 rounded-lg font-medium">
          Create Room
        </button>
      </div>
    </div>
