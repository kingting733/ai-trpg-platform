...
exports.OCCUPATION_BY_NAME = exports.OCCUPATIONS = exports.OCCUPATION_BUFF = void 0;
exports.randomOccupation = randomOccupation;
exports.OCCUPATION_BUFF = 10;
exports.OCCUPATIONS = [
...
function randomOccupation() {
    return exports.OCCUPATIONS[Math.floor(Math.random() * exports.OCCUPATIONS.length)];
}
exports.OCCUPATION_BY_NAME = Object.fromEntries(exports.OCCUPATIONS.map((o) => [o.name, o]));
