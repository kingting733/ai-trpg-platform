...
export interface SceneContext {
  ...
  sceneFacts?: string[];
  /** Ledger facts that happened at the NEXT actor's node. Lets the GM write
   *  choices that follow that scene's own story instead of generic filler. */
  nextSceneFacts?: string[];
}
